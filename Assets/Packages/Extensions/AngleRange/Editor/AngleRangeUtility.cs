...
{
    public class AngleRangeUtility
    {
        ...
        public static void PlayHeadCap(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
        {
            if (styles.playheadTex == null)
                styles.playheadTex = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Scripts/Extensions/AngleRange/Editor/Handles/ss_playhead.png");
        ...
        public static void RangeLeftCap(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
        {
            if (styles.handLeftTex == null)
                styles.handLeftTex = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Scripts/Extensions/AngleRange/Editor/Handles/ss_leftrange.png");
        ...
        public static void RangeRightCap(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
        {
            if (styles.handRightTex == null)
                styles.handRightTex = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Scripts/Extensions/AngleRange/Editor/Handles/ss_rightrange.png");
        ...
        public static void GUITextureCap(int controlID, Texture texture, Vector3 position, Quaternion rotation, float size, EventType eventType)
        {
            switch (eventType)
            {
                ...
                case (EventType.Repaint):
                    ...
                    AngleRangeSpritesUtility.spriteMaterial.mainTexture = texture;
                    ...
                    AngleRangeSpritesUtility.DrawMesh(textureCapMesh, AngleRangeSpritesUtility.spriteMaterial, position, rotation, scale);
