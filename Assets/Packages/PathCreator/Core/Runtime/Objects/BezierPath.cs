...
namespace PathCreation {
 ...
 IsClosed = isClosed;
        ...
        ///<param name="isClosed"> Should the end point connect back to the start point? </param>
        ///<param name="space"> Determines if the path is in 3d space, or clamped to the xy/xz plane </param>
        public BezierPath (IEnumerable<Vector3> points, IEnumerable<Vector3> tangents, bool isClosed = false, PathSpace space = PathSpace.xyz) {
            Vector3[] pointsArray = points.ToArray ();
            Vector3[] tangentsArray = tangents.ToArray ();
            ...
            } else
            {
                ...
                this.points = new List<Vector3> { pointsArray[0], tangentsArray[0], tangentsArray[1], pointsArray[1] };
